...
if __name__ == "__main__":
    ...
    template_file = os.path.join(script_dir, '../cloudformation/main.yml')
    parameters_file = os.path.join(script_dir, '../parameters/params.json')

    stack_name = "email-plugin-stack"
